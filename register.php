...
/**
 * register.php
 * Punto de entrada público para el registro de nuevas cuentas de cliente.
 */
...
<main class="max-w-md mx-auto px-6 py-20">
  <div class="mb-8 text-center">
    <h1 class="font-display text-2xl font-semibold text-white">Crea tu cuenta</h1>
    <p class="text-slate-400 text-sm mt-1">Contrata hosting web o servidores de Minecraft en minutos.</p>
  </div>
  ...
  <form method="POST" action="/register.php" class="bg-surface border border-line rounded-xl p-6 space-y-4">
    <?= csrf_field() ?>
    <div>
      <label class="block text-xs font-mono text-slate-400 mb-1.5">Nombre de usuario</label>
    ...
    <div>
      <label class="block text-xs font-mono text-slate-400 mb-1.5">Confirmar contraseña</label>
  ...
  <p class="text-center text-sm text-slate-500 mt-6">
    ¿Ya tienes cuenta? <a href="/login.php" class="text-cyan hover:underline">Inicia sesión</a>
  </p>
</main>
